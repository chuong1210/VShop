...
using api_be.Models.ValidatorRequest.CustomerValidator;
...
using Sieve.Models;
using Customer = api_be.Entities.Customer;
    ...
    public class CustomerService : ICustomerService
    {
        ...
        public async Task<Result<bool>> Delete(int id)
        {
            try
            {
                ...
                {
                    _context.Set<Entities.Auth.User>().RemoveRange(customer.User);
                }
        ...
        public async Task<Result<CustomerDto>> Detail(DetailBaseCommand request)
        {
            ...
            try
            {
                ...
                var customer = _context.Set<Entities.Customer>().FilterDeleted().Where(x => x.Id == request.Id);
        ...
        public async Task<PaginatedResult<List<CustomerDto>>> GetList(ListBaseCommand request)
        {
            try
            {
                ...
                var query = _context.Set<Entities.Customer>().FilterDeleted();
        ...
        public async Task<Result<CustomerDto>> Update(UpdateCustomerRequest request)
        {
            try
            {
                ...
                var Customer = await _context.Set<Entities.Customer>().FindAsync(request.Id);
