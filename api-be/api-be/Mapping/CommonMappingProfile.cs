...
namespace api_be.Mapping
{
    public class CommonMappingProfile : Profile
    {
        public CommonMappingProfile()
        {
            ...
            CreateMap<List<api_be.Models.Common.Extra>, string>().ConvertUsing<ExtraToStringTypeConverter>();
            CreateMap<string, List<api_be.Models.Common.Extra>>().ConvertUsing<StringToExtraTypeConverter>();
    ...
    public class ExtraToStringTypeConverter : ITypeConverter<List<api_be.Models.Common.Extra>, string>
    {
        public string Convert(List<api_be.Models.Common.Extra> source, string destination, ResolutionContext context)
        {
            if (source == null || source.Count == 0)
            {
                return null;
    ...
    public class StringToExtraTypeConverter : ITypeConverter<string, List<api_be.Models.Common.Extra>>
    {
        public List<api_be.Models.Common.Extra> Convert(string source, List<api_be.Models.Common.Extra> destination, ResolutionContext context)
        {
            if (string.IsNullOrEmpty(source))
            {
                return null;
            ...
            var extraValue = JsonConvert.DeserializeObject<List<api_be.Models.Common.Extra>>(source);
            return extraValue;
        }
    }
