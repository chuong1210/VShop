...
const OrderDetail: React.FC<OrderDetailProps> = ({ orderId }) => {
  ...
  const [orderDetail, setOrderDetail] =
    useState<OrderDetailCollectionType | null>(null);
    ...
    >
      <VStack spacing="6" align="stretch">
            ...
            >
              ...
              <StatGroup>
                ...
                <Stat>
                  ...
                  <StatNumber>
                    {orderDetail.totalDecrease.toLocaleString("vi-VN", {
                      style: "currency",
                      currency: "VND",
                    })}
                  </StatNumber>
        ...
        >
          ...
          <Text>
            {orderDetail.message ? orderDetail.message : "Không có lời nhắn"}
          </Text>
        </Box>
