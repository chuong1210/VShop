...
const ProductDetailBottomAction = () => {
  ...
  const productQuantity = useSelector(
    (state) => state.productDetail.data?.quantity
  );
  ...
  return (
    ...
    >
      <GridItem>
        <Loading show={addToCartMutate.isPending} onTop={true} />
        <Button
          size="md"
          height="48px"
          width="200px"
          ...
          checkLogin={true}
          colorScheme="green"
          leftIcon={<ReactIcon icon="BsFillCreditCard2FrontFill" size={18} />}
        >
          {t("common:buy_now")}
        </Button>
      </GridItem>
      <GridItem>
        <Button
          ...
          checkLogin={true}
          colorScheme="teal"
          leftIcon={<ReactIcon icon="FaCartArrowDown" size={18} />}
          onClick={onAddToCart}
        >
